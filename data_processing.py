...
def preprocess_and_load_dataset(healthy_csv, diseased_csv, path, modality):
...
def load_csv(args):
    ...
    if args.strategy == 'early':
        concat_df = pd.read_csv(os.path.join(data_path, 'concatenate.csv'))
        ...
        cs_df = pd.read_csv(os.path.join(data_path, 'cs_dataset.csv'))
        ...
        sv_df = pd.read_csv(os.path.join(data_path, 'sv_dataset.csv'))
